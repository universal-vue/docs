<template>
  <header class="navbar">
    ...
    <div class="links" :style="{
      ...
      <div>
        <a title="Chat" href="https://discord.gg/3ZZBmFs" target="_blank">
          <svg id="chat" class="picto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g data-name="Layer 2">
        ...
        <a title="Github" href="https://github.com/universal-vue/uvue" target="_blank">
          <svg
            id="github"
            class="picto"
  ...
  data() {
    return {
      ...
      afterLinks: [
        {
          text: "Chat",
          link: "https://discord.gg/3ZZBmFs",
          type: "link",
          items: []
        },
        {
          text: "Github",
          link: "https://github.com/universal-vue",
          type: "link",
          items: []
        }
      ]
